...
<template>
  <v-card>
    <v-card-title>
      <h4 class="mt-2">Weitere Anmeldeinformationen</h4>
    </v-card-title>
    <v-card-text class="d-flex align-center flex-column">
      ...
      >
        ...
        <h4 class="mt-4">Erreichbarkeit während dem Zeltlager</h4>
        <p>
          Damit wir euch während dem Zeltlager erreichen können, bitte hier eine Handynummer
          eingeben, auf der wir während der ganzen Zeit des Zeltlagers einen Jugendleiter erreichen
          können.
        </p>
        <v-text-field
          class="w-75 pt-2"
