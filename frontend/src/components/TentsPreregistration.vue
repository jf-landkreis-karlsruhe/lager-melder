<template>
    ...
    <h3>Voranmeldung Zelte</h3>
      ...
      <v-card-text>
        <p v-if="!short">
            Bitte gebt hier an welche Zelten ihr plant aufzustellen. Sollte euer exaktes Zelt nicht vorhanden sein, wählt das Zelt mit ähnlichen Abmaßen aus.
            Die Anzahl und Größen der Zelte soll uns helfen die größe des Zeltplatzes planen zu können.
        </p>
        ...
        <p v-if="!short">
            Weitere Informationen gibt es auch auf der Herstellerseite von <a href="https://www.lanco.eu/produkte/zelte/zelte-mit-40-mm-aluminiumgerust/sanitats-und-aufenthaltszelte" target="_blank" rel="noopener noreferrer">Lanco</a>.
        </p>
      </v-card-text>
    </v-card>
</template>
