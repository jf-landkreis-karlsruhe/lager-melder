...
export const getTents = () => getData<Tents[]>('tents/', withAuthenticationHeader())
...
export const getTentsForDepartment = (departmentId: number) =>
  getData<Tents>(`departments/${departmentId}/tents`, withAuthenticationHeader())

export const updateTents = (tents: Tents) =>
  putData<Tents>(`tents/department/${tents.departmentId}`, withAuthenticationHeader(), tents)
